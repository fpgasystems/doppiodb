...
int fregex_get_config(char* regex_string, int char_cnt, int state_cnt, byte* config_bytes, int* config_len) {
...
int main(int argc, char** argv) {
	...
	if (argc!=4) {
		printf("Usage: <regex> <chars> <states>");
		return 0;
	}
	...
	fregex_get_config(argv[1], atoi(argv[2]), atoi(argv[3]), config_bytes, &config_len);
